...
See [Protocol reference](https://theodoremeyer.github.io/projects/simplevoicegeyser/protocol.md) for the full websocket message flow, join payload, capability packet, and audio packet formats.
