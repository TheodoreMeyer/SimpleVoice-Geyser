...
export class AppearanceController {
     ...
     * @param {HTMLElement|null} [options.accentGroupEl] Container with `[data-accent]` buttons.
     * @param {HTMLElement|null} [options.borderGroupEl] Container with `[data-border]` buttons.
    ...
    constructor(options) {
        ...
        this.accentGroupEl = options.accentGroupEl || null;
        this.borderGroupEl = options.borderGroupEl || null;
    ...
    init() {
        ...
        this.accentGroupEl?.addEventListener("click", (event) => {
        ...
        this.borderGroupEl?.addEventListener("click", (event) => {
            const target = /** @type {HTMLElement} */ (event.target);
    ...
    #syncActiveSwatches() {
        this.accentGroupEl?.querySelectorAll?.("[data-accent]")?.forEach?.((btn) => {
            const isActive = btn.getAttribute("data-accent") === this.accent;
            btn.classList.toggle("is-active", isActive);
            btn.setAttribute("aria-pressed", String(isActive));
        });
        this.borderGroupEl?.querySelectorAll?.("[data-border]")?.forEach?.((btn) => {
