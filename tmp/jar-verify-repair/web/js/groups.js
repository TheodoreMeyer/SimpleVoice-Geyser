...
export class GroupsController {
    ...
    constructor(options) {
        ...
        /** @type {"NO_GROUP"|"CREATING"|"JOINING"|"JOINING_CREATED_GROUP"|"IN_GROUP"|"LEAVING"} */
        ...
        if (type === "group_created") {
            ...
            if (id) {
                ...
                this.groups.set(id, this.#normalize({
                    ...
                    passwordProtected: existing?.passwordProtected || false,
    ...
    #requestRefresh(options = {}) {
        ...
        this.#syncRefreshButton();
        this.ws.sendGroupsRefresh(operationId);
    }
