...
public class BukkitPlayer extends SvgPlayer {
    ...
    public void refreshOwnedState(Player player) {
        ...
        try {
            ...
            SvgCore.getLogger().debug(
                    "BukkitPlayer: Failed to snapshot yaw for " + name,
                    e
            );
        }
        for (String permission : CACHED_PERMISSIONS) {
            try {
                ...
                SvgCore.getLogger().debug(
                        "BukkitPlayer: Failed to snapshot permission " + permission + " for " + name,
                        e
                );
            }
        }
    ...
    public boolean hasPermission(String permission) {
        ...
        try {
            ...
            SvgCore.getLogger().debug(
                    "BukkitPlayer: Permission refresh schedule failed for " + name,
                    e
            );
        }
    ...
    public void chat(String message) {
        ...
        try {
            ...
            SvgCore.getLogger().debug("BukkitPlayer: chat schedule failed for " + name, e);
        }
    }
    ...
    public void sendMessage(String message) {
        ...
        try {
            ...
            SvgCore.getLogger().debug("BukkitPlayer: sendMessage schedule failed for " + name, e);
        }
    }
    ...
    private Player resolveOnlinePlayer() {
        ...
        // Only call Bukkit player APIs from an entity-owned task.
